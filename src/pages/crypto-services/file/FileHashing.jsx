...
const FileHashing = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('method', hashMethod);
        if (verifyMode) {
            formData.append('hash_to_verify', hashToVerify);
        }

        try {
            const endpoint = `${API_BASE_URL}/${verifyMode ? 'verify-hash' : 'hash'}`;
                ...
                <div className="bg-white rounded-lg shadow-xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            Generate or verify file hashes using various algorithms
                        </p>
                    </div>
